...
const NotFound: React.FC = () => {
  ...
  const quickLinks = [
    { label: t('Dashboard'), icon: Home, path: '/' },
    { label: t('Crop Management'), icon: Wheat, path: '/crops' },
    { label: t('Field Management'), icon: MapPin, path: '/fields' },
  ];
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="space-y-6 mb-12">
          <div className="space-y-3">
            <h2 className="text-3xl font-bold text-gray-900">
              {t('Oops! This field seems to be empty')}
            </h2>
            <p className="text-lg text-gray-600 max-w-md mx-auto">
              {t("The page you're looking for might have been harvested, moved to a different field, or doesn't exist.")}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">
            {t('Or visit these popular sections')}
          </h3>
        ...
        <div className="mt-12 text-center">
          <div className="flex items-center justify-center space-x-2 text-gray-500">
            ...
            <span className="text-sm">{t('Vilaipayir Farm Management System')}</span>
          </div>
        </div>
      </div>
    </div>
